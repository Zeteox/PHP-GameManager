...
<main class="p-8 max-w-7xl mx-auto mb-20 font-sans">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <?php endif; ?>
        <?php foreach ($game_collection as $game): ?>
            <div
                ...
                <div class="relative h-48 border-b-4 border-[#4a3621] overflow-hidden m-2 rounded-t-lg">
                    ...
                    <div
                        ...
                        <?php echo $game['played_times']; ?> h Joué
                    </div>
                </div>
                ...
                <div class="p-5 flex flex-col flex-grow">
                    ...
                    <div class="flex flex-wrap justify-center items-center gap-2 mb-4 border-b border-[#4a3621] pb-4">
                        <span
                            class="text-xs text-[#b8860b] italic uppercase"><?php echo Database::getGenreById($game['id_genre'])['name']; ?></span>
                    ...
                    <div class="text-center mt-auto">
                        <span class="text-[10px] text-[#f0d8a8] font-bold uppercase tracking-wider opacity-80">
                            ...
                            <?= isset($game['added_at']) ? date("d M Y", strtotime($game['added_at'])) : 'Date Inconnue' ?>
                        </span>
                    </div>

                    <div class="text-center mt-auto">
                        <a href="salvageGame.php?game_id=<?php echo $game['id']; ?>"
