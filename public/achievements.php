...
<main class="p-8 max-w-5xl mx-auto mb-20">
    ...
    <div class="flex flex-col gap-6">
        <?php foreach($all_achievements as $achievement): ?>
            <div class="bg-gradient-to-r from-[#4a3621] to-[#1a120b] p-4 rounded-xl border-2 border-[#b8860b] shadow-lg flex flex-col md:flex-row items-center gap-6 <?php echo in_array($achievement, $player_achievement) ? '' : 'opacity-70 grayscale'; ?> hover:border-[#ffd700] transition-colors relative overflow-hidden group">
                ...
                <div class="w-24 h-24 shrink-0 bg-[#1a120b] rounded-full border-4 border-[#ffd700] flex items-center justify-center shadow-inner relative z-10">
                    <img src="assets/achievement/cardPack<?php echo $achievement['id_picture']; ?>.png" alt="Badge" class="max-h-[80%] drop-shadow-xl <?php echo in_array($achievement, $player_achievement) ? 'group-hover:scale-110' : ''; ?> transition-transform duration-300">
                </div>
                ...
                <div class="flex-grow z-10 w-full text-center md:text-left">
                    <div class="flex flex-col md:flex-row justify-between items-center md:items-start mb-2">
                        ...
                        <span class="flex items-center gap-2 text-xs font-bold text-[#1a120b] bg-[#ffd700] px-3 py-1 rounded-full uppercase border border-[#b8860b] mt-2 md:mt-0">
                            + <?php echo $achievement['points']; ?> <img src="assets/dust.png" class="w-4 h-4 drop-shadow-sm" alt="Poussière">
                        </span>
                    </div>
