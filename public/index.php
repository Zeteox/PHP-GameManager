    ...
    <div class="flex flex-col lg:flex-row gap-10 items-center justify-center">
        ...
        <?php if (isset($est_connecte) && $est_connecte): ?>
            <div class="w-full lg:w-1/3 flex flex-col gap-6">
                ...
                <div
                    class="bg-[#1a120b] p-6 rounded-2xl border-4 border-[#4a3621] shadow-[0_10px_25px_rgba(0,0,0,0.8)] relative overflow-hidden group">
                    <div class="absolute inset-0 bg-gradient-to-t from-[#6b1111]/20 to-transparent pointer-events-none">
                    </div>
                    <div class="flex items-center gap-4 relative z-10">
                        <div
                            class="w-16 h-16 rounded-full border-2 border-[#ffd700] overflow-hidden shrink-0 shadow-[0_0_10px_rgba(255,215,0,0.5)]">
                            <img src="assets/icon/icon.jpg" class="w-full h-full object-cover">
                        </div>
                        <div>
                            <p class="text-[#ffd700] font-black text-lg uppercase tracking-wider font-serif">Votre Profil
                            </p>
                            <a href="compte.php"
                                class="text-xs text-[#b8860b] hover:text-white uppercase transition-colors flex items-center gap-1 mt-1">
