...
require __DIR__ . '/../../app/home/HomeUtils.php';
...
<head>
    ...
    <title><?php echo $pageTitle ?? "La Taverne"; ?></title>
</head>
        ...
        <div class="max-w-7xl mx-auto px-4 py-3 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div class="flex items-center gap-3">
                <img src="assets/icon/icon.jpg" alt="Logo"
                    class="w-12 h-12 object-cover rounded-full border-2 border-[#ffd700]">
                <span
                    class="text-2xl font-black uppercase tracking-tighter hs-text-shadow text-[#ffd700]">La Taverne</span>
            </div>
            ...
            <nav>
                <ul class="flex gap-6 md:gap-8 uppercase tracking-widest text-sm font-bold items-center">
                    <li>
                        <a href="index.php"
                            class="nav-link flex items-center justify-center gap-2 hover:text-[#ffd700] transition-colors py-2 text-[#f0d8a8]">
                            <img src="assets/icon/homeIcon.png" alt="Accueil"
                    ...
                    <li>
                        <a href="shop.php"
                            class="nav-link flex items-center justify-center gap-2 hover:text-[#ffd700] transition-colors py-2 text-[#f0d8a8]">
                            <img src="assets/icon/shop.png" alt="Boutique"
                                class="w-7 h-7 object-contain drop-shadow-md">
                    ...
                    <?php if ($is_connected): ?>
                        <li>
                            <a href="account.php"
                                class="nav-link flex items-center justify-center gap-2 hover:text-[#ffd700] transition-colors py-2 text-[#f0d8a8]">
                                <img src="assets/icon/profileIcon.png" alt="Mon Compte"
                                    class="w-7 h-7 object-contain drop-shadow-md">
            ...
            <div class="hidden md:flex items-center gap-4">
                ...
                <?php else: ?>
                    <a href="login.php"
                        class="bg-[#6b1111] hover:bg-[#8b1515] border-2 border-[#ffd700] text-white font-bold uppercase text-xs px-5 py-2 rounded shadow-lg transition transform active:scale-95">
                        Se connecter
                    </a>
                <?php endif; ?>
            </div>
